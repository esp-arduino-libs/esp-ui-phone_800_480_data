...
#define ESP_UI_PHONE_800_480_DARK_HOME_DATA()                              \
    {                                                                      \
        .status_bar = ESP_UI_PHONE_800_480_DARK_STATUS_BAR_DATA(),         \
        .navigation_bar = ESP_UI_PHONE_800_480_DARK_NAVIGATION_BAR_DATA(), \
        .app_launcher = ESP_UI_PHONE_800_480_DARK_APP_LAUNCHER_DATA(),     \
        .recents_screen = ESP_UI_PHONE_800_480_DARK_RECENTS_SCREEN_DATA(), \
        .flags = {                                                         \
            .enable_status_bar = 1,                                        \
